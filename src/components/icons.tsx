...
export const MenuIcon = ({className}: IconProps): JSX.Element => (
  <svg
    className={className}
...
export const MetamaskIcon = ({className}: IconProps): JSX.Element => (
  <svg
    className={className}
    fill="currentColor"
    viewBox="0 0 35 33"
...
export const WalletConnectIcon = ({className}: IconProps): JSX.Element => (
  <svg
    className={className}
    viewBox="0 0 300 185"
    version="1.1"
