...
interface ChangeFeeProposalDataInterface extends ethers.utils.Interface {
  functions: {
...
export class ChangeFeeProposalData extends Contract {
  ...
  interface: ChangeFeeProposalDataInterface;
