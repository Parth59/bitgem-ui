...
interface PancakeSwapQueryHelperInterface extends ethers.utils.Interface {
  functions: {
...
export class PancakeSwapQueryHelper extends Contract {
  ...
  interface: PancakeSwapQueryHelperInterface;
