...
interface IFundProjectProposalDataInterface extends ethers.utils.Interface {
  functions: {
...
export class IFundProjectProposalData extends Contract {
  ...
  interface: IFundProjectProposalDataInterface;
