...
interface IMintPoolGemsProposalDataInterface extends ethers.utils.Interface {
  functions: {
...
export class IMintPoolGemsProposalData extends Contract {
  ...
  interface: IMintPoolGemsProposalDataInterface;
