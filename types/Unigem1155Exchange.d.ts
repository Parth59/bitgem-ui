...
interface Unigem1155ExchangeInterface extends ethers.utils.Interface {
  functions: {
...
export class Unigem1155Exchange extends Contract {
  ...
  interface: Unigem1155ExchangeInterface;
