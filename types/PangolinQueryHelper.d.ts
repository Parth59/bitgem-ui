...
interface PangolinQueryHelperInterface extends ethers.utils.Interface {
  functions: {
...
export class PangolinQueryHelper extends Contract {
  ...
  interface: PangolinQueryHelperInterface;
