...
interface NFTGemWrappedERC20FuelInterface extends ethers.utils.Interface {
  functions: {
...
export class NFTGemWrappedERC20Fuel extends Contract {
  ...
  interface: NFTGemWrappedERC20FuelInterface;
