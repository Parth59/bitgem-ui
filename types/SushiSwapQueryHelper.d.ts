...
interface SushiSwapQueryHelperInterface extends ethers.utils.Interface {
  functions: {
...
export class SushiSwapQueryHelper extends Contract {
  ...
  interface: SushiSwapQueryHelperInterface;
