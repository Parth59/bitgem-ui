...
interface Unigem1155FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class Unigem1155Factory extends Contract {
  ...
  interface: Unigem1155FactoryInterface;
