...
interface FuniswapQueryHelperInterface extends ethers.utils.Interface {
  functions: {
...
export class FuniswapQueryHelper extends Contract {
  ...
  interface: FuniswapQueryHelperInterface;
