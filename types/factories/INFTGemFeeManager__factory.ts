...
import type { INFTGemFeeManager } from "../INFTGemFeeManager";

export class INFTGemFeeManager__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): INFTGemFeeManager {
    return new Contract(address, _abi, signerOrProvider) as INFTGemFeeManager;
  }
}
