...
import type { INFTGemMultiToken } from "../INFTGemMultiToken";

export class INFTGemMultiToken__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): INFTGemMultiToken {
    return new Contract(address, _abi, signerOrProvider) as INFTGemMultiToken;
  }
}
