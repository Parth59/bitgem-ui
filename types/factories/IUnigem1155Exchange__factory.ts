...
import type { IUnigem1155Exchange } from "../IUnigem1155Exchange";

export class IUnigem1155Exchange__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IUnigem1155Exchange {
    return new Contract(address, _abi, signerOrProvider) as IUnigem1155Exchange;
  }
}
