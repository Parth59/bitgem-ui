...
import type { INFTComplexGemPool } from "../INFTComplexGemPool";

export class INFTComplexGemPool__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): INFTComplexGemPool {
    return new Contract(address, _abi, signerOrProvider) as INFTComplexGemPool;
  }
}
