...
interface IUnigem1155FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IUnigem1155Factory extends Contract {
  ...
  interface: IUnigem1155FactoryInterface;
