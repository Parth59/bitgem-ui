...
interface FundProjectProposalDataInterface extends ethers.utils.Interface {
  functions: {
...
export class FundProjectProposalData extends Contract {
  ...
  interface: FundProjectProposalDataInterface;
