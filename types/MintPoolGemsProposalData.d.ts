...
interface MintPoolGemsProposalDataInterface extends ethers.utils.Interface {
  functions: {
...
export class MintPoolGemsProposalData extends Contract {
  ...
  interface: MintPoolGemsProposalDataInterface;
